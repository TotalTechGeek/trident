...
function peg$parse(input, options) {
  ...
  var peg$f0 = function(data) { return { cat: data } };
  var peg$f1 = function(startTag, content, endTag) {
  ...
  var peg$f2 = function(startTag) { return startTag; };
  var peg$f3 = function(name, args) { return { name, args, newline: true }; };
  var peg$f4 = function(name, args) { return { name, args }; };
  var peg$f5 = function(name, args) { 
  if (!args.length)  return { var: name }; 
  return { [name]: args }
};
  var peg$f6 = function(name) { return name; };
  var peg$f7 = function(test, chars) { return test.join('') + chars.join(""); };
  var peg$f8 = function(chars) { return chars.join(""); };
  var peg$f9 = function(chars) { return chars.flat().join(""); };
  var peg$f10 = function(data) { return data };
  var peg$f11 = function(chars) { return { var: chars.join("") }; };
  var peg$f12 = function(chars) { return parseInt(chars.join(""), 10) };
  var peg$f13 = function(chars) { return chars.join(""); };
  var peg$f14 = function(chars) { return chars.join(""); };
  var peg$f15 = function(name, args) { return { [name]: args } };
